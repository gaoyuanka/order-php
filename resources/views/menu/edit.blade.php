        ...
        <div class="progress-table-wrap">
            ...
            <div class="progress-table">
                <div class="table-row">
                    ...
                    <div class="mt-10">
                        <input type="text" name="name" placeholder="料理名(必須)" value="{{ old('name') ? old('name') : $menu->name}}"
                        onfocus="this.placeholder = ''" onblur="this.placeholder = '料理名(必須)'" required class="single-input" {{MenuController::getOnlyRead()}}>
                    </div>
                    @error('name')
                        <p>
                            {{ $errors->first('name') }}
                ...
                <div class="table-row">
                    ...
                    <div class="mt-10">
                        <input type="text" name="furi_name" placeholder="ふりがな(必須)" value="{{ old('furi_name')  ? old('furi_name') : $menu->furi_name}}"
                ...
                <div class="table-row">
                    ...
                    <div class="mt-10">
                        <input type="text" name="price" placeholder="値段(必須)" value="{{old('price')  ? old('price') : $menu->price}}"
                    ...
                    <div class="form-select">
                        <select name="rest_menu_kind_id">
                            ...
                            @foreach ($menu_kinds as $menu_kind)
                                @if ($menu_kind->kind_id == $menu->rest_menu_kind_id)
                        ...
                        <div class="single-element-widget">
                            <div class="switch-wrap d-flex justify-content-between">
                                <div class="primary-switch">
                                    ...
                                    @else
                                        <input type="checkbox" name="is_lunch" id="is_lunch"  >
                                    @endif
                        ...
                        <div class="single-element-widget">
                            <div class="switch-wrap d-flex justify-content-between">
                                <div class="primary-switch">
                                    ...
                                    @else
                                        <input type="checkbox" name="is_dinner" id="is_dinner"  >
                                    @endif
                ...
                <div class="table-row">
                    ...
                    <div class="info">
                        <textarea class="single-textarea" name="info" placeholder="料理紹介" onfocus="this.placeholder = ''" 
                            onblur="this.placeholder = '料理紹介'">{{old('info') ? old('info') : $menu->info}}</textarea>
                    </div>
                </div>
                ...
                <div class="table-row">
                    ...
                    <div class="col-lg-5 d-flex justify-content-end">
                        <button class="primary-btn green-bg d-inline-flex align-items-center mt-20" name="action" value="update"><span
